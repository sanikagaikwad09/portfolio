...
export function HeroDoodles() {
  ...
  return (
    <div className="absolute inset-0 pointer-events-none z-10 select-none">
      ...
      <motion.div
        className="absolute top-[12%] left-[-4%] text-charcoal/15 dark:text-warm-white/15 w-7 h-7"
      ...
      <motion.div
        className="absolute bottom-[14%] left-[-8%] text-accent opacity-45 w-12 h-10 -rotate-12"
        style={{ x: doodleX3, y: doodleY3 }}
        animate={floatAnim(0.5, 6)}
      >
      ...
      <motion.div
        className="absolute bottom-[22%] right-[-6%] text-charcoal/15 dark:text-warm-white/15 w-7 h-7"
        style={{ x: doodleX2, y: doodleY2 }}
      ...
      <motion.div
        className="absolute bottom-[2%] right-[4%] text-charcoal/10 dark:text-warm-white/10 w-12 h-12"
        style={{ x: doodleX1, y: doodleY1 }}
